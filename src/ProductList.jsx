...
import {addItem,selectTotalQuantity,selectCartItems } from "./CartSlice";
...
function ProductList() {
    ...
    const totalQuantity = useSelector(selectTotalQuantity); // Get total quantity from Redux store
    const cart = useSelector(selectCartItems); // Get the cart items from Redux store
